...
# Setting 1: All Beta_1 drawn from 3.47 + unif(-.25, .25)
############################
...
# (3) Preserve pi
out$pi_ham <- pi_ham <- pi_ham_opt$par
...
saveRDS(results_tmp2, file = "./data/results_setting4_rep_level.RDS")
saveRDS(ci, file = "./data/results_setting4_coeff_level.RDS")